...
interface ModalContainerProps{
    ...
    modalComponent:React.FC; //React 컴포넌트를 나타내는 타입으로 변경함
}

const ModalContainer:React.FC<ModalContainerProps> = ({modalRef,modalComponent:ModalComponent}) => {
    const [modalState,setModalState]=useRecoilState(modalStateAtom);
    return (
            <ModalOutSide ref={modalRef} modalState={modalState} >
                <ModalBodyWrapper >
